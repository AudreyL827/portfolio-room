    ...
    <group key={P.name}>
      ...
      <WallGroup j={0}>
        ...
        <Artwork id="work-2" art="wave" pos={[0, -3.9]} w={2.8} seed={12} P={P} plaque
          icon={{ name: 'sail', accent: ACCENTS.pink, fx: 0.67, fy: 0.62, fs: 8.5 }} />
        <Artwork id="work-3" art="scream" pos={[3.1, -3.7]} w={2.0} seed={13} P={P} plaque
          icon={{ name: 'sun', accent: ACCENTS.gold, fx: 0.72, fy: 0.08, fs: 10 }} />
        ...
        <GlbStatue url={`${MODELS}david.glb`} pos={[-5.2, 0]} rot={0.5} height={2.5}
          ...
          pedestal={{ w: 1.3, h: 0.9 }} title="David" sub="after Michelangelo · scan" P={P} />
      </WallGroup>
      ...
      <WallGroup j={1}>
        ...
        <GlbStatue url={`${MODELS}caracalla.glb`} pos={[5.6, 0]} rot={-0.4} height={1.15}
          pedestal={{ w: 0.95, h: 1.5 }} title="Caracalla" sub="Roman, c. 212 AD · scan" P={P} />
      ...
      <WallGroup j={3}>
        <Artwork id="portrait" art="mona" pos={[-2.5, -3.4]} w={2.0} seed={5} P={P} plaque
          icon={{ name: 'question', accent: ACCENTS.pink, fx: 0.74, fy: 0.28, fs: 9 }} />
        <Artwork id="contact" art="letter" pos={[2.7, -3.6]} w={1.7} seed={17} P={P} plaque
          icon={{ name: 'envelope', accent: ACCENTS.red, fx: 0.28, fy: 0.8, fs: 8.5 }} />
        ...
        <GlbStatue url={`${MODELS}female-statue.glb`} pos={[0.1, 0]} rot={0.4} height={2.0}
          pedestal={{ w: 1.3, h: 0.7 }} title="Winged Victory" sub="after Samothrace · scan" P={P} />
        <GlbStatue url={`${MODELS}thinker.glb`} pos={[3.6, 0]} rot={-0.5} height={1.7}
          preRotate={[-Math.PI / 2, 0, 0]}
          pedestal={{ w: 1.2, h: 0.95 }} title="The Thinker" sub="after Rodin · scan" P={P} />
      </WallGroup>
